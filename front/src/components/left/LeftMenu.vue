<template>
  <div class="left-content" id="leftContent">
    <div class="left-component-tab">
      <div
        class="tab"
        style="left: 0; border-right: solid 1px var(--color-gray2);"
        :class="{ active: activeLeftTab === 'tree' }"
        @click="changeActiveLeftTab('tree')"
      >
        tree
      </div>
    ...
    <div class="left-component">
      <div class="app-row" style="top: 40px; bottom: 0;">
        <keep-alive>
          <function-tree v-if="activeLeftTab === 'edit'" />

          <directory-tree v-if="activeLeftTab === 'tree'" />
        </keep-alive>
